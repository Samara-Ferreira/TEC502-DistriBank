...
async def main(num):
    ...
    if num == 1:
        urls = [
            ...
            f"http://{host1}:{port1}/silvio/08500000000/sil11/silvio123/500.0/create_physical_particular",
            f"http://{host1}:{port1}/gustavo/08400000000/guga01/guga123/500.0/create_physical_particular",
        ]
    # testes em bancos diferentes
    elif num == 2:
        urls = [
            f"http://{host1}:{port1}/thiago/08300000000/thi03/thiago123/500.0/create_physical_joint",
    ...
    # testes conta conjunta
        ...
        urls = [
            ...
            f"http://{host1}:{port1}/14000000000000/silvio/sil11/08500000000/silvio123/create_juridic_employee",
            f"http://{host1}:{port1}/14000000000000/sival/val11/08400000000/sival123/create_juridic_employee",
        ]
